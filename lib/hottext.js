(function(context) {
  ...
  var DEFAULTS = {
    ...
    inputActiveClass: 'hottext-input-active',
    labelActiveClass: 'hottext-label-active',
  ...
  HotText.prototype.toggleInputActive = function(on) {
    ...
    if(on) {
      addClass(this.area, this.options.inputActiveClass);
      removeClass(this.area, this.options.labelActiveClass);
      this.isSelectBox ? this.input.focus() : this.input.select();
    } else {
      addClass(this.area, this.options.labelActiveClass);
      removeClass(this.area, this.options.inputActiveClass);
    }
  };
